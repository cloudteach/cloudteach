...
- (void)initControlBtn {
    ...
    backView.frame = CGRectMake(0, cancelBtn.frame.origin.y, [UIScreen mainScreen].bounds.size.width, cancelBtn.frame.size.height);
    backView.backgroundColor = [UIColor blackColor];
    [self.view insertSubview:backView belowSubview:cancelBtn];
}
...
//    }
    NSDictionary *dicHead = @{@"head":[self getSubImage]};
