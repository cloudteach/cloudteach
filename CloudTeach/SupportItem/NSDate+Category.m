...
- (NSString *)minuteDescription
{
    ...
    {//昨天
        [dateFormatter setDateFormat:@"a h:mm"];
        dateString = [NSString stringWithFormat:NSEaseLocalizedString(@"NSDateCategory.text7", @'"'),[dateFormatter stringFromDate:self]];
    ...
    if([dateString rangeOfString:@"上午 12"].location !=NSNotFound)
    {
        return [dateString stringByReplacingOccurrencesOfString:@"上午 12" withString:@"上午 00"];
    }else
    {
        return dateString;
    }
